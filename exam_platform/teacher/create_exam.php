        ...
        <div class="card" style="margin-top:16px;">
            <div class="card-body">
                ...
                <div class="exam-link-box" style="margin-top:12px;">
                    <div class="exam-link-url" id="editExamLink"><?= htmlspecialchars(($_SERVER['HTTP_X_FORWARDED_PROTO'] ?? ($_SERVER['REQUEST_SCHEME'] ?? 'http')) . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost') . '/exam_platform/exam/' . $editForm['exam_link']) ?></div>
